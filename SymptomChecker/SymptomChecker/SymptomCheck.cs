...
{
    public partial class SymptomCheck : Form {
        ...
        private void Request_btn_Click(object sender, EventArgs e) {
            try {
                ...
                Symptom_ComboBox.Text = Settings.Default.symptomsNames;
            } catch (Exception ex) {
        ...
        private void App_Load(object sender, EventArgs e) {
            ...
            if (Settings.Default.name == "") {
                ...
                register.Cancel_btn.Enabled = false;
                register.ShowDialog();
            }
        ...
        private void AddSymptoms_btn_Click(object sender, EventArgs e) {
